...
export function HorseRacing({
  ...
  return (
    ...
    >
      ...
      {error ? (
        <p className="horse-racing__notice horse-racing__notice--error" role="alert">
          {error}
        </p>
      ) : null}
      ...
      <div className="horse-racing__suits" aria-label={t('horseRacing.suitsLabel')}>
